...
class PandasCommand(commands.Cog):
    def __init__(self, client: commands.Bot):
        self.client = client

    @slash_command(description="Random pandas from the internet!")
    async def pandas(self, interaction):
...
def setup(client):
    client.add_cog(PandasCommand(client))