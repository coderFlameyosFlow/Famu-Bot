...
class BirbsCommand(commands.Cog):
    def __init__(self, client: commands.Bot):
        self.client = client

    @slash_command(description="Random birbs from the internet!")
    async def birbs(self, interaction):
...
def setup(client):
    client.add_cog(BirbsCommand(client))   