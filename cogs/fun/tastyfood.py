...
class FoodCommand(commands.Cog):
    def __init__(self, client: commands.Bot):
        self.client = client

    @slash_command(description="Random food from the internet (really tasty looking)!")
    async def tastyfood(self, interaction):
...
def setup(client):
    client.add_cog(FoodCommand(client))